...
(function () {
  ...
  const B = G.battle = {
    ...
    finishWin: function () {
      ...
      if (first && first.def.truelast === 3) { G.flags.phantomDead = 1; G.endBattle('phantom'); return; }
      if (first && first.def.truelast === 2) { G.flags.elderDead = 1; G.endBattle('elder'); return; }
